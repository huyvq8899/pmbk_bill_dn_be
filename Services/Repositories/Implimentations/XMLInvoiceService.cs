        ...
        private async Task CreateInvoiceND123TT78Async(string xmlFilePath, HoaDonDienTuViewModel model)
        {
            ...
            switch ((LoaiHoaDon)model.LoaiHoaDon)
            {
                case LoaiHoaDon.HoaDonGTGT:
                    ...
                    {
                        ttkhac_ThongTinSaiSot.Add(new ViewModels.XML.QuyDinhKyThuatHDDT.PhanII.II._2.a.TTin { TTruong = "ThongTinHoaDonSaiSot", KDLieu = "string", DLieu = model.GhiChuThayTheSaiSot });
                    }
