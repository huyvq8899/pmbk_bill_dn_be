...
namespace Services.Repositories.Implimentations.QuanLyHoaDon
{
    public class HoaDonDienTuService : IHoaDonDienTuService
    {
        Datacontext _db;
        IMapper _mp;
        IDoiTuongService _doiTuongService;
        IMauHoaDonService _mauHoaDonService;
        IThamChieuService _thamChieuService;
        IDoiTruChungTuService _doiTruChungTuService;
        ...
        IKhoanMucChiPhiService _khoanMucChiPhiService;
        IDanhGiaLaiTaiKhoanNgoaiTeService _danhGiaLaiTaiKhoanNgoaiTeService;
        ...
        public HoaDonDienTuService(
            ...
            IDoiTruChungTuService doiTruChungTuService,
            ITaiKhoanKeToanService taiKhoanKeToanService,
            ITaiKhoanNganHangService taiKhoanNganHangService,
            ISoCongNoDoiTuongService soCongNoDoiTuongService,
            IKhoanMucChiPhiService khoanMucChiPhiService,
            IDanhGiaLaiTaiKhoanNgoaiTeService danhGiaLaiTaiKhoanNgoaiTeService,
            ...
            IHostingEnvironment IHostingEnvironment)
        {
            ...
            _doiTruChungTuService = doiTruChungTuService;
            _taiKhoanKeToanService = taiKhoanKeToanService;
            _taiKhoanNganHangService = taiKhoanNganHangService;
            _soCongNoDoiTuongService = soCongNoDoiTuongService;
            _khoanMucChiPhiService = khoanMucChiPhiService;
            _danhGiaLaiTaiKhoanNgoaiTeService = danhGiaLaiTaiKhoanNgoaiTeService;
        ...
        public string ExportExcelChungTuKeToan(ChungTuNghiepVuKhacViewModel model)
        {
            string excelFileName = SaveToExcelChungTuKeToan(model).excelFileName;
        ...
        public async Task<PagedList<HoaDonDienTuViewModel>> GetAllPagingAsync(PagingParams pagingParams)
        {
            IQueryable<HoaDonDienTuViewModel> query = _db.HoaDonDienTus
                ...
                .Select(hd => new HoaDonDienTuViewModel
                {
                    ...
                    LoaiTien = _mp.Map<NgoaiTeViewModel>(_db.NgoaiTes.FirstOrDefault(x=>x.NgoaiTeId == hd.LoaiTienId)),
                    TyGia = hd.TyGia ?? 1,
            ...
            if (!string.IsNullOrEmpty(pagingParams.KeywordCol))
            {
                ...
                {
                    query = query.Where(x => x.KhachHang.LienHe_HoVaTen.ToUpper().ToUnSign().Contains(keyword.ToUnSign()) || x.KhachHang.LienHe_HoVaTen.ToUpper().Contains(keyword));
                }
                ...
                {
                    query = query.Where(x => x.KhachHang.HoaDon_TenNguoiNhan.ToUpper().ToUnSign().Contains(keyword.ToUnSign()) || x.KhachHang.HoaDon_TenNguoiNhan.ToUpper().Contains(keyword));
                }
                if (pagingParams.ColName == "EmailNguoiNhan")
                {
                    query = query.Where(x => x.KhachHang.HoaDon_EmailNguoiNhan.ToUpper().ToUnSign().Contains(keyword.ToUnSign()) || x.KhachHang.HoaDon_EmailNguoiNhan.ToUpper().Contains(keyword));
                }
                if (pagingParams.ColName == "SoDienThoaiNguoiNhan")
                {
                    query = query.Where(x => x.KhachHang.HoaDon_DienThoaiNguoiNhan.ToUpper().ToUnSign().Contains(keyword.ToUnSign()) || x.KhachHang.HoaDon_DienThoaiNguoiNhan.ToUpper().Contains(keyword));
                }
        ...
        public async Task<HoaDonDienTuViewModel> GetByIdAsync(string id)
        {
            var result = from hd in _db.HoaDonDienTus
                         ...
                         join lt in _db.NgoaiTes on hd.LoaiTienId equals lt.NgoaiTeId into tmpLoaiTiens
                         ...
                         select new HoaDonDienTuViewModel
                         {
                             ...
                             LoaiTienId = lt.NgoaiTeId ?? string.Empty,
                             LoaiTien = lt != null ? _mp.Map<NgoaiTeViewModel>(lt) : null,
                             TyGia = hd.TyGia ?? 1,
                             TrangThai = hd.TrangThai,
                             TrangThaiPhatHanh = hd.TrangThaiPhatHanh,
                             MaTraCuu = hd.MaTraCuu,
                             ...
                             HoaDonChiTiets = (
                                                ...
                                                join vt in _db.VatTu_HangHoas on hdct.VT_HHId equals vt.VT_HHId into tmpHangHoas
                                                ...
                                                select new HoaDonDienTuChiTietViewModel
                                                {
                                                    ...
                                                    VT_HHId = vt.VT_HHId ?? string.Empty,
                                                    VT_HH = vt != null ? _mp.Map<VatTu_HangHoaViewModel>(vt) : null,
