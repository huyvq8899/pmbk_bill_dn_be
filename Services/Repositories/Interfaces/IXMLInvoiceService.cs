...
namespace Services.Repositories.Interfaces
{
    public interface IXMLInvoiceService
    {
        ...
        Task<bool> CreateXmlCMTMTT(string xmlFilePath, HoaDonDienTuViewModel model);
        ...
        Task CreateThongDiepGuiHoaDonCMTMTT(string xmlFilePathGTGT, string xmlFilePathBanHang, string xmlFilePathKhac, List<HoaDonDienTuViewModel> lstHoaDon, TTChungThongDiep ttChungGTGT, TTChungThongDiep ttChungBanHang, TTChungThongDiep ttChungKhac);
    }
}
