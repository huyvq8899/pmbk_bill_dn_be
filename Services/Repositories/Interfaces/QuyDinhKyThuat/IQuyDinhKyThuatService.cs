...
namespace Services.Repositories.Interfaces.QuyDinhKyThuat
{
    public interface IQuyDinhKyThuatService
    {
        ...
        /// <returns></returns>
        Task<PagedList<ThongDiepChungViewModel>> GetPagingThongDiepChungInTransLogsAsync(ThongDiepChungParams @params);
        ...
        Task<int> GetTrangThaiGuiToKhaiDangKyThayDoi(string ThongDiepGuiCQTId);
    }
}
