...
namespace Services.Repositories.Interfaces.QuyDinhKyThuat
{
    public interface IDuLieuGuiHDDTService
    {
        ...
        Task<string> GuiThongDiepDuLieuHDDTAsync2(ThongDiepChungViewModel model, string token);
        Task<bool> GuiThongDiepDuLieuHDDTAsync4(string ThongDiepId,bool isGuiVe=false);
        ...
        Task<List<ThongDiepChungViewModel>> InsertThongDiep206(ThongDiepChungViewModel model);
        Task<bool> LuuDuLieuDaKy(ThongDiepChungViewModel model);
    }
}
