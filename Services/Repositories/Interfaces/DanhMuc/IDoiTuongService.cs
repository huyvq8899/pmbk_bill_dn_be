...
namespace Services.Repositories.Interfaces.DanhMuc
{
    public interface IDoiTuongService
    {
        ...
        Task<ResultParams> FilterInsertKhachHangAsync(DoiTuongViewModel model);
        Task<DoiTuong> GetKhachHangByMa(string ma);
        Task<DoiTuong> GetNhanVienByMa(string ma);
        ...
        Task<DoiTuong> CheckTrungMaPosAsync(DoiTuongViewModel model);
        ...
        Task<List<DoiTuongViewModel>> GetAllPagingKhachHangXuatKhauAsync(DoiTuongParams @params);
    }
}
