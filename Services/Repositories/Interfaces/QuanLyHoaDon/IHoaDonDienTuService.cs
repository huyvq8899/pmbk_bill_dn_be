...
namespace Services.Repositories.Interfaces.QuanLyHoaDon
{
    ...
    {
        Task<ResultParams2> FilterPosInsertInvoices(HoaDonDienTuViewModel model);
        ...
        Task<HoaDonDienTuViewModel> PosGetByIdAsync(string id);
        Task<List<HoaDonDienTuViewModel>> GetHoaDonByTrangThaiQuyTrinhAsync(int trangthaiQuyTrinh);
        ...
        Task<HoaDonDienTuViewModel> GetHoaDonGocCuaHDBI(string hoadonBiThayTheId,string loai);
        ...
        Task<string> XoaBoHoaDon(ParamXoaBoHoaDon @params);
        ...
        Task<bool> PhatHanhHoaDonCoMaTuMTT(HoaDonDienTuViewModel model);
        ...
        Task<List<FileReturn>> MultiCreateXMLToSignAsync(List<HoaDonDienTuViewModel> list);
        ...
        Task<List<HoaDonDienTuViewModel>> PhatHanhHoaDonCoMaTuMTTDongLoat(List<string> hoaDonIds);
        ...
        Task<bool> UpdateIsTBaoHuyKhongDuocChapNhan();
        Task<bool> XacNhanHoaDonDaGuiChoKhachHang(string strHoaDonDienTuId);
        Task<bool> InsertTuyChonHoaDonTroVeTruocAsync();
        Task<int> GetHoaDonMttYeuCauHuy();
        Task<string> GuiThongDiep206BackgroundAsync(string dateTimeStart);
    }
}
