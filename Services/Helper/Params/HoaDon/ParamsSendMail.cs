...
namespace Services.Helper.Params.HoaDon
{
    ...
    public class ParamsSendMailThongBaoSaiThongTin
    {
        ...
        public bool? TichChon_SoDienThoai { get; set; }
        public bool? TichChon_CanCuocCongDan { get; set; }
        ...
        public string CanCuocCongDan_Sai { get; set; }
        public string CanCuocCongDan_Dung { get; set; }
        public string SoDienThoai_Dung { get; set; }
        public string SoDienThoai_Sai { get; set; }
        public string GiaiTrinhSaiSot { get; set; }
        public string TenNguoiNhan { get; set; }
