...
namespace Services.Helper
{
    public static class TransferLogHelper
    {
        ...
        //public static async Task<bool> AddToTCTTransfer(string dataXML)
        //{
        //    bool res = false;
        ...
        //        string con = "Server=10.10.20.11;Database=TCTTranfer;User Id=sa;Password=Bk9108vn;MultipleActiveResultSets=true";

        //        TTChungThongDiep log = new TTChungThongDiep();
        ...
        //            {
        //                XDocument xDoc = XDocument.Load(reader);
        //                log = xDoc.Descendants("TTChung")
        //                               .Select(x => new TTChungThongDiep
        //                               {
        //                                   PBan = x.Element(nameof(log.PBan)).Value,
        //                                   MNGui = x.Element(nameof(log.MNGui)).Value,
        //                                   MNNhan = x.Element(nameof(log.MNNhan)).Value,
        //                                   MLTDiep = x.Element(nameof(log.MLTDiep)).Value,
        //                                   MTDiep = x.Element(nameof(log.MTDiep)).Value,
        //                                   MTDTChieu = x.Element(nameof(log.MTDTChieu)).Value,
        //                                   MST = x.Element(nameof(log.MST)).Value
        //                               }).FirstOrDefault();
        //            }
        //        }
        ...
        //                command.Parameters["@DataXML"].Value = dataXML;
