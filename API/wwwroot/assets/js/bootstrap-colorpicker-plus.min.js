...
!function (a) {
    ...
    var b = ["#5B0F00", "#660000", "#783F04", "#7F6000", "#274E13", "#0C343D", "#1C4587", "#073763", "#20124D", "#4C1130", "#5B0F00", "#660000", "#783F04", "#7F6000", "#274E13", "#0C343D", "#1C4587", "#073763", "#20124D", "#4C1130", "#85200C", "#990000", "#B45F06", "#BF9000", "#38761D", "#134F5C", "#1155CC", "#0B5394", "#351C75", "#741B47", "#A61C00", "#CC0000", "#E69138", "#F1C232", "#6AA84F", "#45818E", "#3C78D8", "#3D85C6", "#674EA7", "#A64D79", "#CC4125", "#E06666", "#F6B26B", "#FFD966", "#93C47D", "#76A5AF", "#6D9EEB", "#6FA8DC", "#8E7CC3", "#C27BA0", "#DD7E6B", "#EA9999", "#F9CB9C", "#FFE599", "#B6D7A8", "#A2C4C9", "#A4C2F4", "#9FC5E8", "#B4A7D6", "#D5A6BD", "#E6B8AF", "#F4CCCC", "#FCE5CD", "#FFF2CC", "#D9EAD3", "#D0E0E3", "#C9DAF8", "#CFE2F3", "#D9D2E9", "#EAD1DC", "#980000", "#FF0000", "#FF9900", "#FFFF00", "#00FF00", "#00FFFF", "#4A86E8", "#0000FF", "#9900FF", "#FF00FF", "#000000", "#222222", "#444444", "#666666", "#888888", "#AAAAAA", "#CCCCCC", "#DDDDDD", "#EEEEEE", "#FFFFFF"]
      ...
      , d = [];
    c && (c.getItem("colorpickerplus_custom_colors") || c.setItem("colorpickerplus_custom_colors", d.join("$")),
    d = c.getItem("colorpickerplus_custom_colors").split("$"));
    var e = 9
      , f = 10
      , g = function (b, c) {
          return c || (c = a('<div class="colorcell"></div>')),
          b ? (c.data("color", b),
          c.css("background-color", b)) : c.addClass("colorpicker-color"),
          c
      }
      , h = function (c) {
          ...
          for (k = 0; e > k; k++) {
              j = null,
              e - 2 > k ? j = a('<div class="colorpickerplus-colors-row"></div>') : (k === e - 2 && a('<div class="colorpickerplus-custom-colors"></div>').appendTo(h),
              j = a('<div class="colorpickerplus-colors-row"></div>'));
              for (var p = 0; f > p; p++) {
                  var q = b[k * f + p];
                  g(q).appendTo(j)
              }
          ...
          var r = a('<div class="input-group input-group-sm"><input type="text" class="form-control"/><span class="input-group-btn"><button class="btn btn-default" type="button" title="Custom Color">C</button></span></div>')
            , s = a("input", r);
          r.appendTo(h),
          h.on("click.colorpickerplus-container", ".colorcell", a.proxy(this.select, this)),
          r.on("click.colorpickerplus-container", "button", a.proxy(this.custom, this)),
          s.on("changeColor.colorpickerplus-container", a.proxy(this.change, this)),
          h.on("click", a.proxy(this.stopPropagation, this)),
          s.colorpicker(),
          this.element = c,
          this.colorInput = s[0]
      };
    h.prototype = {
        ...
        custom: function () {
            ...
            var f = a(".nonecell", b)
              , h = g(e, f.first());
            h.removeClass("nonecell"),
            h.addClass("colorcell"),
            c.setItem("colorpickerplus_custom_colors", d.join("$"))
        },
        select: function (b) {
            var c = a(this.element)
              , d = a(b.target).data("color");
            if (null == d)
                c.trigger("changeColor", [d]);
            else {
                var e = a(this.colorInput);
                e.val(d),
                e.colorpicker("setValue", d),
                this.update(d)
            }
            c.trigger("select", [d]),
            a(this.colorInput).colorpicker("hide")
        },
        change: function (b) {
            var c = a(this.element);
            b.stopPropagation(),
            c.trigger("changeColor", [b.color.toHex()])
        },
        update: function (b) {
            var c = a(this.element)
              , d = a(".colorcell", c);
            if (d.removeClass("selected"),
            null != b) {
                var e = a(this.colorInput);
                e.val(b)
            }
            d.each(function () {
                ...
                return null != b && c === b.toUpperCase() ? (a(this).addClass("selected"),
                !1) : void 0
            })
        },
    ...
    a.colorpickerembed = h,
    a.fn.colorpickerembed = function (b) {
        var c = arguments;
    ...
    i.length <= 0 && (i = a('<div class="colorpickerplus"></div>'),
    i.appendTo(a("body")));
    ...
    var l = function (a) {
        j.data("colorpickerembed").update(a.getValue()),
        k = a,
        i.show()
    }
      , m = function () {
      ...
      , p = function (b, c) {
          ...
          e && 0 === e.length && (e = !1),
          e !== !1 && (d.on("focus", a.proxy(this.show, this)),
          this.input = e[0]),
          e === !1 && d.on("click", a.proxy(this.show, this)),
          this.element = b
      };
    p.version = "0.1.0",
    p.prototype = {
        ...
        destroy: function () {
            var b = a(this.element);
            b.removeData("colorpickerplus").off(".colorpickerplus"),
            this.input !== !1 && a(this.input).off(".colorpickerplus"),
            b.trigger("destroy")
        },
        reposition: function () {
            n(this)
        ...
        show: function () {
            var b = a(this.element);
            this.reposition(),
            a(window).on("resize.colorpickerplus", a.proxy(this.reposition, this)),
            a(window.document.body).on("mouseup.colorpickerplus", a.proxy(this.hide, this)),
            l(this),
            b.trigger("showPicker", [this.getValue()])
        },
        hide: function (b) {
            var c = a(this.element)
              , d = a(b.target)
              , e = d.closest(".colorpicker, .colorpickerplus");
            e.length > 0 || d.is("input") || (m(),
            a(window).off("resize.colorpickerplus"),
            a(window.document.body).off("mouseup.colorpickerplus"),
            c.trigger("hidePicker", [this.getValue()]))
        },
        setValue: function (b) {
            var c = a(this.element);
            b ? c.data("cpp-color", b) : c.removeData("cpp-color"),
            c.trigger("changeColor", [b])
        },
        getValue: function (b) {
            var c = a(this.element);
            b = void 0 === b ? "#000000" : b;
            var d;
            return d = this.hasInput() ? a(this.input).val() : c.data("cpp-color"),
            (void 0 === d || "" === d || null === d) && (d = b),
            "string" == typeof d ? d.toUpperCase() : d
        },
        hasInput: function () {
            return this.input !== !1
        }
    ...
    a.colorpickerplus = p,
    a.fn.colorpickerplus = function (b) {
        var c = arguments;
        return this.each(function () {
            var d = a(this)
