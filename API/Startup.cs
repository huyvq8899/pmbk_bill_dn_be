...
using Services.Repositories.Implimentations.Pos;
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            buiders =>
            {
                buiders
                    ...
                    .WithOrigins("https://*.pmbk.vn", "http://localhost:4200", "http://localhost:4300", "http://vecatba.ddns.net:8081");
            }));
            ...
            services.AddScoped<IHopDongHoaDonService, HopDongHoaDonService>();
            ...
            services.AddScoped<IDigitalSignerNameReaderService, DigitalSignerNameReaderService>();
            #endregion
            ...
            #region Pos
            services.AddScoped<IPosTransferService, PosTransferService>();
            #endregion
            #region ESignCloud
            services.AddScoped<IESignCloudService, ESignCloudService>();
            #endregion
            // bỏ dấu #
