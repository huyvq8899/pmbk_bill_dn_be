...
namespace API.Controllers.QuanLyHoaDon
{
    public class ThongDiepGuiNhanCQTController : BaseController
    {
        ...
        [HttpGet("GetNgayCoQuanThueCapMa202/{hoaDonDienTuId}")]
        public async Task<IActionResult> GetNgayCoQuanThueCapMa202(string hoaDonDienTuId)
        {
            var result = await _IThongDiepGuiNhanCQTService.GetNgayCoQuanThueCapMa202(hoaDonDienTuId);
            return Ok(new { result });
        }
        #endregion
        /// <summary>
