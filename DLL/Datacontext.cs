...
namespace DLL
{
    public class Datacontext : DbContext
    {
        ...
        public DbSet<TuyChonHoaDon> TuyChonHoaDons { get; set; }
        #endregion
        ...
        #region Quản lý
        public DbSet<BoKyHieuDangPhatHanh> BoKyHieuDangPhatHanhs { get; set; }
        ...
        public DbSet<SinhSoHDMayTinhTien> SinhSoHDMayTinhTiens { get; set; }
        public DbSet<MauFile_HoaDon> MauFile_HoaDons { get; set; }

        #endregion
        public DbSet<HopDongHoaDon> HopDongHoaDons { get; set; }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            #region Quản lý
            modelBuilder.AddConfiguration(new BoKyHieuDangPhatHanhConfiguration());
