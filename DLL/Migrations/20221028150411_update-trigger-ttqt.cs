...
{
    public partial class updatetriggerttqt : Migration
    {
            ...
            migrationBuilder.Sql(@"IF (OBJECT_ID('[dbo].[UpdateHoaDonDienTu]') IS NOT NULL)
                                    ...
                                    BEGIN
                                        ...
                                        BEGIN
	                                        ...
	                                        WHERE MaCuaCQT IS NOT NULL AND TrangThaiQuyTrinh != 9 AND BoKyHieuHoaDonId IN (SELECT BoKyHieuHoaDonId FROM BoKyHieuHoaDons WHERE HinhThucHoaDon = 1)
                                        END
                                    END");
