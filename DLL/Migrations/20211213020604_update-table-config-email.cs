...
{
    public partial class updatetableconfigemail : Migration
    {
                ...
                {
                                {
                                    ...
                                    "</div>" + Environment.NewLine +
                                    "<div style='color: #9b9b9b; padding: 8px 0; text-align: center'>Copyright ⓒ2020 PHAN MEM BACH KHOA</div>" + Environment.NewLine +
                                    "</div>" + Environment.NewLine +
                                    "</div>"
                                },
                                {
