...
namespace DLL.Migrations
{
    ...
    [Migration("20221205095715_add-phan-quyen-ticket")]
    partial class addphanquyenticket
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DLL.Entity.Config.TaiKhoanSmartCA", b =>
                {
                    b.Property<string>("TaiKhoanSmartCAId")
                        .ValueGeneratedOnAdd()
                        .HasMaxLength(36);
                    ...
                    b.Property<string>("PasswordSmartCA");
                    ...
                    b.Property<string>("UserNameSmartCA");

                    b.HasKey("TaiKhoanSmartCAId");

                    b.ToTable("TaiKhoanSmartCAs");
                });
            ...
            modelBuilder.Entity("DLL.Entity.Ticket.TuyenDuong", b =>
                {
                    b.Property<Guid>("TuyenDuongId")
                        .ValueGeneratedOnAdd()
                        .HasMaxLength(36);
            ...
            modelBuilder.Entity("DLL.Entity.Ticket.User_Xe", b =>
                {
                    b.Property<string>("UserId")
                        .HasMaxLength(36);
            ...
            modelBuilder.Entity("DLL.Entity.Ticket.Xe", b =>
                {
                    b.Property<string>("XeId")
                        .ValueGeneratedOnAdd()
                        .HasMaxLength(36);
            ...
            modelBuilder.Entity("DLL.Entity.DanhMuc.MauHoaDon", b =>
                {
                    b.HasOne("DLL.Entity.Ticket.TuyenDuong", "TuyenDuong")
                        .WithMany("MauHoaDons")
            ...
            modelBuilder.Entity("DLL.Entity.QuanLyHoaDon.HoaDonDienTu", b =>
                {
                    ...
                    b.HasOne("DLL.Entity.Ticket.Xe", "Xe")
                        .WithMany("HoaDonDienTus")
                        .HasForeignKey("XeId")
                        .OnDelete(DeleteBehavior.Restrict);
                });
