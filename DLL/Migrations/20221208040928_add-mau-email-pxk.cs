...
{
    public partial class addmauemailpxk : Migration
    {
                ...
                {
                    {
                        ...
                        false,
                        (int)LoaiEmail.ThongBaoPhatHanhPXK,
                        "##tendonvi## gửi phiếu xuất kho điện tử số ##so## cho ##tenkhachhang##",
                        "<style type='text/css'>.container { " +
                                     ...
                                     "##tendonvi## xin trân trọng gửi phiếu xuất kho điện tử cho Quý khách với các thông tin như sau:</div>" + Environment.NewLine +
                                     ...
                                     "<ul style = 'margin-left:25px' >" + Environment.NewLine +
                                         "<li>Ký hiệu mẫu số phiếu xuất kho:&nbsp;<strong>##mauso##</strong></li>" + Environment.NewLine +
                                         "<li>K&yacute; hiệu phiếu xuất kho:&nbsp;<strong>##kyhieu##</strong></li>" + Environment.NewLine +
                                         "<li>Số phiếu xuất kho: <strong>##so##</strong></li>" + Environment.NewLine +
                                         "<li>Ngày phiếu xuất kho: <strong>##ngayhoadon##</strong></li>" + Environment.NewLine +
                                         "<li>Tổng tiền thanh toán: <strong>##tongtien##</strong></li>" + Environment.NewLine +
                                     "</ul>" + Environment.NewLine +
                                     "</div>" + Environment.NewLine +
                                     "<div class='content-text' style='color:#030303; font-family:Tahoma,serif; line-height:26px; padding:10px 20px 10px 20px'>Để tra cứu v&agrave; k&yacute; điện tử tr&ecirc;n phiếu xuất kho, Qu&yacute; kh&aacute;ch vui l&ograve;ng nhấn n&uacute;t:<br />" + Environment.NewLine +
                                     "&nbsp;" + Environment.NewLine +
                                     ...
                                     "Qu&yacute; kh&aacute;ch vui l&ograve;ng kiểm tra, đối chiếu nội dung ghi tr&ecirc;n phiếu xuất kho.</div>" + Environment.NewLine +
...

                    {
                        Guid.NewGuid().ToString(),
                        false,
                        (int)LoaiEmail.ThongBaoXoaBoPXK,
                        "##tendonvi## gửi thông báo xóa bỏ phiếu xuất kho điện tử số ##so## cho ##tenkhachhang##",
                        @"<div class='container' style='font-family:Tahoma; font-size:14px; margin-bottom:0px; margin-left:0px; margin-right:0px; margin-top:0px; width:100%'>  <div class='body' style='padding:10px'>  <div class='subject' style='background-color:#0070C0; border-top-left-radius:4px; border-top-right-radius:4px; padding: 10px 20px 10px 20px'><span style = 'color:#ffffff; font-family:Tahoma; font-size:20px' >##tendonvi##<br>Gửi thông báo xóa bỏ phiếu xuất kho cho Quý khách</span></div>  <div class='content' style='background-color:#fafafa; border-color:#e1e1e1; border-style:none solid solid; border-width:1px'>  <div class='content-text' style='color:#030303; font-family:Tahoma,serif; line-height:26px; padding:10px 20px 0px 20px'><!--<div class='note' style='font-size: 14px;color: red;margin-bottom: 10px;'>  <i><b>Chú ý</b>: Đây là email tự động từ hệ thống, vui lòng không phản hồi (reply) lại email này</i>  </div>--><strong>K&iacute;nh gửi: Qu&yacute; kh&aacute;ch&nbsp;##tennguoinhan##</strong><br/> ##tendonvi## xin trân trọng thông báo với Quý khách: Chúng tôi đã thực hiện xóa bỏ phiếu xuất kho điện tử với các thông tin như sau:</div>  <div class='content-text' style='color:#030303; font-family:Tahoma,serif; line-height:26px; padding:5px 20px 10px 20px'>Th&ocirc;ng tin phiếu xuất kho x&oacute;a bỏ:</div>  <div class='detail' style='background-color:#FFF2CC; line-height:30px; padding:1px'>  
                                <ul style = 'margin-left:25px' >    
                                    <li>Ký hiệu mẫu số phiếu xuất kho:&nbsp;<strong>##mauso##</strong></li>  
                                    <li>K&yacute; hiệu phiếu xuất kho:&nbsp;<strong>##kyhieu##</strong></li>  
                                    <li>Số phiếu xuất kho:&nbsp;<strong>##so##</strong></li>  
...

                    {
                        Guid.NewGuid().ToString(),
                        false,
                        (int)LoaiEmail.ThongBaoBienBanDieuChinhPXK,
                        "##tendonvi## gửi biên bản điều chỉnh phiếu xuất kho điện tử số ##so## cho ##tenkhachhang##",
...

                    {
                        Guid.NewGuid().ToString(),
                        false,
                        (int)LoaiEmail.ThongBaoSaiThongTinKhongPhaiLapLaiPXK,
                        "##tendonvi##\r\nGửi thông báo phiếu xuất kho có thông tin sai sót không phải lập lại phiếu xuất kho cho Quý khách",
