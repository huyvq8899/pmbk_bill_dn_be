...
{
    public partial class addthietlapemailmacdinh : Migration
    {
                ...
                {
                                {
                                    ...
                                    "<div style='padding:6px 0;'><img style='width:700px;' src='##link##/assets/logo.png'/></div>" + Environment.NewLine +
                                    "<div class='subject' style='background-color:#0f97f1; border-top-left-radius:4px; border-top-right-radius:4px; height:70px;line-height:70px;padding-left: 20px;'><span style = 'color:#ffffff; font-family:Tahoma; font-size:22px; white-space: pre-wrap!important;text-align: justify!important;' >##tendonvi##&nbsp;th&ocirc;ng b&aacute;o gửi ##loaihoadon## cho Qu&yacute; kh&aacute;ch</span></div>"
                                    + Environment.NewLine +
