...
namespace DLL.Migrations
{
    ...
    [Migration("20221022014450_Add-New-Column-SoBatDauCMCQT-In-BoKyHieu")]
    partial class AddNewColumnSoBatDauCMCQTInBoKyHieu
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DLL.Entity.FeedBack", b =>
                {
            ...
            modelBuilder.Entity("DLL.Entity.ThongKeTrangThai", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd()
                        .HasMaxLength(36);
                    ...
                    b.ToTable("ThongKeTrangThais");
                });

            modelBuilder.Entity("DLL.Entity.ThongKeTrangThaiItem", b =>
                {
                    b.Property<int?>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.Property<int?>("SttShow");

                    b.Property<string>("TenTrangThai");

                    b.Property<string>("ThongKeTrangThaiId");

                    b.Property<int>("TrangThai");

                    b.HasKey("Id");

                    b.HasIndex("ThongKeTrangThaiId");

                    b.ToTable("ThongKeTrangThaiItems");
                });

            modelBuilder.Entity("DLL.Entity.TienIch.NhacViec", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd()
                        .HasMaxLength(36);
            ...
            modelBuilder.Entity("DLL.Entity.QuanLy.BoKyHieuHoaDon", b =>
                {
                    b.HasOne("DLL.Entity.DanhMuc.MauHoaDon")
            ...
            modelBuilder.Entity("DLL.Entity.ThongKeTrangThaiItem", b =>
                {
                    b.HasOne("DLL.Entity.ThongKeTrangThai")
                        .WithMany("ThongKeTrangThaiItems")
                        .HasForeignKey("ThongKeTrangThaiId");
                });
