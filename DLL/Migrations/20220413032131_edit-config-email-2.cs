        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.UpdateData(
                ...
                value: "<style type='text/css'>.container { " +
                                     ...
                                     "</div>" + Environment.NewLine +
                                     "<div style='color: #9b9b9b; padding: 8px 0; text-align: center'>Copyright ⓒ2021 PHAN MEM BACH KHOA</div>" + Environment.NewLine +
                                     "</div>" + Environment.NewLine +
                                     "</div>"
                );
            ...
            migrationBuilder.UpdateData(
                ...
                value:
                                    ...
                                    "<div class='body' style='padding:40px'>" + Environment.NewLine +
                                    "<div class='subject' style='background-color:#0070C0; border-top-left-radius:4px; border-top-right-radius:4px; height:70px; line-height:70px; padding-left:20px'><span style = 'color:#ffffff; font-family:Tahoma; font-size:22px' >##tendonvi##<br>Gửi biên bản hủy hóa đơn cho Quý khách</span></div>" + Environment.NewLine +
